...
(function( root, factory ) {
  ...
  root.Localize.msg = new root.TabGlobalize('ja');
...
Globalize.b1136762192 = messageFormatterFn((function(  ) {
  return function (d) { return "閉じる"; }
})(), Globalize("ja").pluralGenerator({}));
Globalize.b1995155880 = messageFormatterFn((function(  ) {
  return function (d) { return "ダイアログを閉じる"; }
})(), Globalize("ja").pluralGenerator({}));
Globalize.b1046274326 = messageFormatterFn((function(  ) {
  return function (d) { return "カスタム カラー"; }
})(), Globalize("ja").pluralGenerator({}));
Globalize.b396775413 = messageFormatterFn((function(  ) {
  return function (d) { return "差分"; }
})(), Globalize("ja").pluralGenerator({}));
Globalize.a1734748135 = messageFormatterFn((function(  ) {
  return function (d) { return "増分"; }
})(), Globalize("ja").pluralGenerator({}));
Globalize.b1027454504 = messageFormatterFn((function(  ) {
  return function (d) { return "待機インジケーター"; }
})(), Globalize("ja").pluralGenerator({}));
}));
