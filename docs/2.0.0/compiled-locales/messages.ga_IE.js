...
(function( root, factory ) {
  ...
  root.Localize.msg = new root.TabGlobalize('ga');
...
Globalize.a1707598665 = pluralGeneratorFn(function(n
/*``*/) {
...
Globalize.a1078900013 = messageFormatterFn((function(  ) {
  return function (d) { return "Close"; }
})(), Globalize("ga").pluralGenerator({}));
Globalize.a1418336021 = messageFormatterFn((function(  ) {
  return function (d) { return "Close dialog"; }
})(), Globalize("ga").pluralGenerator({}));
Globalize.b1927749721 = messageFormatterFn((function(  ) {
  return function (d) { return "Custom color"; }
})(), Globalize("ga").pluralGenerator({}));
Globalize.a1859288072 = messageFormatterFn((function(  ) {
  return function (d) { return "Decrement"; }
})(), Globalize("ga").pluralGenerator({}));
Globalize.b304155676 = messageFormatterFn((function(  ) {
  return function (d) { return "Increment"; }
})(), Globalize("ga").pluralGenerator({}));
Globalize.b1399674245 = messageFormatterFn((function(  ) {
