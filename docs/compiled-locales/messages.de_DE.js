...
Globalize.a369903489 = messageFormatterFn((function(  ) {
  return function (d) { return "Schrittweise verringern"; }
})(), Globalize("de").pluralGenerator({}));
Globalize.b1793540259 = messageFormatterFn((function(  ) {
  return function (d) { return "Schrittweise erhöhen"; }
})(), Globalize("de").pluralGenerator({}));
