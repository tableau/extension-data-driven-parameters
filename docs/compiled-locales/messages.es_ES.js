...
(function( root, factory ) {
  ...
  root.Localize.msg = new root.TabGlobalize('es');
...
Globalize.b597593895 = messageFormatterFn((function(  ) {
  return function (d) { return "Cerrar"; }
})(), Globalize("es").pluralGenerator({}));
Globalize.b753638975 = messageFormatterFn((function(  ) {
  return function (d) { return "Cerrar cuadro de diálogo"; }
})(), Globalize("es").pluralGenerator({}));
Globalize.a195242579 = messageFormatterFn((function(  ) {
  return function (d) { return "Color personalizado"; }
})(), Globalize("es").pluralGenerator({}));
Globalize.a109543860 = messageFormatterFn((function(  ) {
  return function (d) { return "Disminuir"; }
})(), Globalize("es").pluralGenerator({}));
Globalize.b2053899888 = messageFormatterFn((function(  ) {
  return function (d) { return "Aumentar"; }
})(), Globalize("es").pluralGenerator({}));
Globalize.b2129967537 = messageFormatterFn((function(  ) {
  return function (d) { return "Indicador de espera"; }
})(), Globalize("es").pluralGenerator({}));
}));
