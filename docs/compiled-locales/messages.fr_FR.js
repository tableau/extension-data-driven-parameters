...
(function( root, factory ) {
  ...
  root.Localize.msg = new root.TabGlobalize('fr');
...
Globalize.a350244347 = messageFormatterFn((function(  ) {
  return function (d) { return "Fermer"; }
})(), Globalize("fr").pluralGenerator({}));
Globalize.b53650077 = messageFormatterFn((function(  ) {
  return function (d) { return "Fermer la boîte de dialogue"; }
})(), Globalize("fr").pluralGenerator({}));
Globalize.a895231477 = messageFormatterFn((function(  ) {
  return function (d) { return "Couleur personnalisée"; }
})(), Globalize("fr").pluralGenerator({}));
Globalize.b64029226 = messageFormatterFn((function(  ) {
  return function (d) { return "Décrémenter"; }
})(), Globalize("fr").pluralGenerator({}));
Globalize.a2067494322 = messageFormatterFn((function(  ) {
  return function (d) { return "Incrémenter"; }
})(), Globalize("fr").pluralGenerator({}));
Globalize.b70234003 = messageFormatterFn((function(  ) {
  return function (d) { return "Indicateur d'attente"; }
})(), Globalize("fr").pluralGenerator({}));
}));
