...
(function( root, factory ) {
  ...
  root.Localize.msg = new root.TabGlobalize('pt');
...
Globalize.b1818146365 = messageFormatterFn((function(  ) {
  return function (d) { return "Fechar"; }
})(), Globalize("pt").pluralGenerator({}));
Globalize.a2072273707 = messageFormatterFn((function(  ) {
  return function (d) { return "Fechar diálogo"; }
})(), Globalize("pt").pluralGenerator({}));
Globalize.b1273812035 = messageFormatterFn((function(  ) {
  return function (d) { return "Cor personalizada"; }
})(), Globalize("pt").pluralGenerator({}));
Globalize.b151202402 = messageFormatterFn((function(  ) {
  return function (d) { return "Decrementar"; }
})(), Globalize("pt").pluralGenerator({}));
Globalize.a1980321146 = messageFormatterFn((function(  ) {
  return function (d) { return "Incrementar"; }
})(), Globalize("pt").pluralGenerator({}));
Globalize.a1594145189 = messageFormatterFn((function(  ) {
